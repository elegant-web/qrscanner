...
bcQrReader = function($timeout) {
  return {
    ...
    template: '<div><webcam on-stream="onStream(stream)" on-error="onError(err)" ng-if="active" channel="channel" deviseid="deviseid"></webcam><canvas id="qr-canvas"></canvas></div>',
